---
title: Building a Static Site Generator (SSG) with Rust
description: Thoughts on the process of building the SSG paper
thumbnail:
  author: Louis Reed
  authorLink: https://unsplash.com/@_louisreed?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
  width: 2400
  height: 1599
  url: /images/building-a-ssg-with-rust/hero.jpg
isArchived: false
